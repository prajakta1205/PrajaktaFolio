      ...
      "
        ...
        <div className="max-w-3xl w-full md:order-1">
          ...
          <p className="mt-6 text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            architectures using .NET and Microsoft Azure. Proficient in building
            efficient backend systems using REST APIs and modern front-end
            technologies like React and micro-frontend architecture.
          </p>
